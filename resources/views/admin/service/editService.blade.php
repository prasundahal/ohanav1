                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ route('updateService',$service->id) }}" class="form-image-upload" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="meta_service_title" value="{{$service->meta_service_title}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <strong>Meta Description</strong>
                                <textarea class="form-control" name="meta_service_description" rows="5">{{$service->meta_service_description}}</textarea>
                            </div>
                            <div class="form-group">
                                <br>
