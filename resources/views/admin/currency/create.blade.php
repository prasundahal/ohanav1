        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="{{ route('admin.currency.store') }}" class="form-image-upload" method="POST"
                            enctype="multipart/form-data" id="form">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <strong>Name</strong>
                                <input type="text" name="currency_code" class="form-control" placeholder="Eg, INR, NPR">
                            ...
                            <div class="form-group">
                                <strong>Rate</strong>
                                <input type="text" name="rate" class="form-control" placeholder="1">
                                <div class="require text-danger rate"></div>
                            </div>
                            <div class="form-group">
                                <strong>Commision</strong>
                                <input type="text" name="commission" class="form-control" placeholder="1">
