...
<link href="https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200;0,300;0,400;0,600;0,700;1,200&display=swap" rel="stylesheet">
            ...
            <div class="row">
                <div class="col-xl-2 col-lg-4 col-md-6 col-12">
                    <div class="footer-logo-box text_white">
                        <div class="footer-logo mb-3">
                            <a class="footer-logo  our-services-text font-weight-bold text-uppercase  font-weight-bolder p-0" href="index.html">
                ...
                <div class="col-xl-2 col-lg-2 col-md-6 col-12 mt-xl-0 mt-md-0 mt-5">
                    <div class="footer-title text_white footer_after">
                        <h4 class="mb-3 mb-md-4 our-services-text">Important Links </h4>
                        <ul class="text-white p-0">
                            <li class="mb-2"><a href="/" class="our-services-text ">Support</a></li>
                            <li class="mb-2"><a href="{{ url('/service') }}" class="our-services-text ">Privacy Policy</a></li>
                            <li class="mb-2"><a href="{{ url('/about') }}" class="our-services-text ">Terms & Condition</a></li>
                            {{-- <li class="mb-2">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-12 mt-xl-0 mt-md-5 mt-5">
                    <div class="footer-title text_white footer_after footer-title2">
                        ...
                        <p class="our-services-text mb-3"> <span class="mr-3"><i class="fa fa-map-marker" aria-hidden="true"></i></span>{{$settings->company_location}}
                        </p>
                        <a href="#" class="our-services-text mb-3 d-block">
                            <span class="mr-2"><i class="fa fa-phone" aria-hidden="true"></i></span> {{$settings->phone_number}},
                        </a>
                        <a href="mailto:{{$settings->email}}" class="our-services-text mb-3 d-block">
                            <span class="mr-2"><i class="fa fa-envelope" aria-hidden="true"></i></span> {{$settings->email}}
                        </a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-12 mt-xl-0 mt-md-5 mt-5">
                    <div class="footer-title text_white footer_after footer-title2">
                        ...
                        <form enctype="multipart/form-data" method="post" action="{{ url('suscribe')}}">
                            ...
                            <div class="button-footer d-flex mt-4">
                                <input type="email" name="email" class="form-control bg-transparent border-0" placeholder="Email Address ">
                                <button type="submit" class="footer-btn footer-bg-btn our-services-text text-center font-weight-normal">SIGN
                                    UP</button>
                            </div>
                        </form>
                        <div class="social-icon-footer mr-xl-5 mr-md-2 mr-0 mt-3 d-md-block d-flex">
                            <ul class="d-flex justify-content-start p-0">
                                <li class="logo-bg "><a href="{{$settings->facebook}}" class="our-services-text"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                <li class="feature_in_bg "><a href="{{$settings->instagram}}" class="our-services-text"=""=""><i class="fa fa-instagram" aria-hidden="true"></i></a>
                                </li>
                                <li class="logo-bg "><a href="{{$settings->youtube}}" class="our-services-text"=""=""><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
                                <li class="logo-bg "><a href="{{$settings->linkedin}}" class="our-services-text"=""=""><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
