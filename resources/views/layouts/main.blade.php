...
<link href="https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200;0,300;0,400;0,600;0,700;1,200&display=swap"
    rel="stylesheet">
        ...
        <div class=" container">
                    ...
                    <div class="footer-logo-box text_white">
                        <div class="footer-logo mb-3">
                            <a class="footer-logo  our-services-text font-weight-bold text-uppercase  font-weight-bolder p-0"
                                href="index.html">
                                <img src="{{ asset('/public/frontend/image/logo/logo.png') }}" class="img-fluid "
                                    alt=""></a>
                        </div>
                ...
                <div class="col-xl-2 col-lg-2 col-md-6 col-12 mt-xl-0 mt-md-0 mt-5">
                    <div class="footer-title text_white footer_after">
                        ...
                        <ul class="text-white p-0">
                            ...
                            <li class="mb-2"><a href="{{ url('/service') }}"
                                    class="our-services-text ">Services</a></li>
                            <li class="mb-2"><a href="{{ url('/about') }}" class="our-services-text ">About
                                    Us</a></li>
                            {{-- <li class="mb-2">
                                <a href="" class="our-services-text ">FAQ</a>
                            </li> --}}
                            <li class="mb-2"><a href="{{ url('/contact') }}"
                                    class="our-services-text ">Contact Us</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer-title text_white footer_after footer-title2">
                        ...
                        <div class="social-icon-footer mr-xl-5 mr-md-2 mr-0 mt-3 d-md-block d-flex">
                            <ul class="d-flex justify-content-start p-0">
                                <li class="logo-bg "><a href="{{ $settings->facebook }}"
                                        class="our-services-text"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                </li>
                                <li class="feature_in_bg "><a href="{{ $settings->instagram }}"
                                        class="our-services-text"=""=""><i class="fa fa-instagram"
                                            aria-hidden="true"></i></a>
                                </li>
                                <li class="logo-bg "><a href="{{ $settings->youtube }}"
                                        class="our-services-text"=""=""><i class="fa fa-google-plus"
            ...
            <div class="row">
                <div class="col-12 justify-content-center align-items-center">
                    ...
                    <h6 class="testimonial-title mx-auto  my-2 text-center">Powered by {{ $settings->company_name }} |
                    </h6>
                </div>
            </div>
        </div>
