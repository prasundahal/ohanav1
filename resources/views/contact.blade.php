    ...
    <div class="container">
        <div class="row">
            <div class="col-12 title-description-wrapper mx-auto mb-5">
                <div class="title text-center mb-3">
                    ...
                    <!-- <hp>
                        ...
                        for($i=0;$i<count($location);$i++){ echo $location[$i].'<br>';
                            }
                            @endphp
                            </p> -->
                </div>
            ...
            <div class="col-xl-5 col-lg-5 col-12">
                <form class="mt-45" id="contact" enctype="multipart/form-data" method="post" action="{{ route('createmessage')}}">
                    {{ csrf_field() }}
                    <div class="contact-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="sub" name="subject" class="form-control" placeholder="Your Phone Number" value="">
                        </div>
                        <div class="form-group">
...
<section id="map" class="location-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d56522.299158869304!2d85.30192792654009!3d27.69740520177342!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb198a307baabf%3A0xb5137c1bf18db1ea!2sKathmandu%2044600!5e0!3m2!1sen!2snp!4v1620992118229!5m2!1sen!2snp" style="border:0;" allowfullscreen="true" loading="lazy"></iframe>
</section>
{{-- contactus --}}
